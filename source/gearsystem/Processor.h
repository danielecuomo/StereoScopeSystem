...
public:
    ...
    u32 RunInstruction();
    u64 GetInstructionCount() const;
#if GS_PERF_DIAGNOSTICS
    const u32* GetOpcodeHistogram() const { return m_opcodeHistogram; }
    const u32* GetOpcodeCBHistogram() const { return m_opcodeCBHistogram; }
    const u32* GetOpcodeEDHistogram() const { return m_opcodeEDHistogram; }
#endif
...
private:
    ...
    bool m_bBranchTaken;
    u32 m_iTStates;
    u32 m_iInjectedTStates;
    u64 m_instructionCount;
#if GS_PERF_DIAGNOSTICS
    u32 m_opcodeHistogram[256];
    u32 m_opcodeCBHistogram[256];
    u32 m_opcodeEDHistogram[256];
#endif
    bool m_bAfterEI;
...
private:
    ...
    u16 FetchArg16();
    void ExecuteOPCode();
    void DispatchOpcode(u8 opcode);
    void DispatchOpcodeCB(u8 opcode);
    void DispatchOpcodeED(u8 opcode);
