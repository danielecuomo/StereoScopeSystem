...
public:
    ...
    unsigned int GetCyclesToNextEvent() const;
    u8 GetVCounter();
    u8 GetHCounter();
    u8 GetDataPort();
    u8 GetStatusFlags();
...
private:
    ...
    u16 m_SG1000_palette_565_rgb_sg1000ii[16];
...
const u8 kSG1000_palette_888_sg1000ii[48] = {0,0,0, 0,0,0, 36,218,36, 200,255,109, 36,36,255, 72,109,255, 182,36,36, 72,218,255, 255,36,36, 255,175,175, 230,230,0, 230,230,200, 36,195,36, 218,72,182, 182,182,182, 255,255,255};
